...
if __name__ == "__main__":
    ...
    ppo = PPO(action_space, obs_fn, model_fn, train_epoch=5, batch_size=32, save_path='./ppo_stack_log')
        ...
        if death_frame > 0:
            ...
            for i in range(batch_size):
                ...
                if traj_size >= death_frame:
                    ...
                    retain_ob_batch.append(s_batchs[i][:-death_frame + 1])
